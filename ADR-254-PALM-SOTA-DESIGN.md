...
## 🔐 사용자 합의 사항 (2026-05-24)

| # | 항목 | 결정 |
|---|---|---|
| 1 | 라이브러리 자동 설치 (~200MB) | ✅ 허용 |
| 2 | D: 50GB 사용 | ✅ 허용 |
| 3 | 인터넷 자동 다운로드 (~3GB) | ✅ 허용 |
| 4 | 자동 git commit + push | ✅ 허용 |
| 5 | 라이브 deploy 정책 | **B — 자동 + 자동 revert** |
| 6 | 실패 시 자동 fallback | ✅ 허용 |
| 7 | GPU 100% 사용 | ✅ 허용 |
| 8 | fly.toml 메모리 1GB 업그레이드 | **✅ 허용** (+$1.81/월) |
| 9 | 학습 후 부산물 정리 | ✅ 허용 |
| 10 | 알림 빈도 | **B — Phase + 오류만** |
| **앙상블 구성** | **옵션 B — 3-모델 (CFM + DeepLab + SegFormer)** | **메모리 1GB 사용** |
