"""engine.safety.standard_doc_builder — §14.5 회귀 테스트."""
...
def test_markdown_starts_with_header_ko():
    from engine.safety.standard_doc_builder import build_markdown_report
...
def test_json_summary_has_top_level_fields():
    from engine.safety.standard_doc_builder import build_json_summary
...
def test_json_string_is_valid_json():
    from engine.safety.standard_doc_builder import build_json_string
    s = build_json_string()
    parsed = json.loads(s)
...
def test_audit_letter_korean_format():
    from engine.safety.standard_doc_builder import build_audit_letter
