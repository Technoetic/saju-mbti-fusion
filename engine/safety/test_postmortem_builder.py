"""engine.safety.postmortem_builder — §14.8 회귀 테스트."""
...
def test_five_whys_template_returns_5_items():
    from engine.safety.postmortem_builder import build_five_whys_template
...
def test_build_draft_basic():
    from engine.safety.postmortem_builder import build_draft
    d = build_draft(
...
def test_build_draft_accepts_timeline():
    from engine.safety.postmortem_builder import build_draft, TimelineEvent
    timeline = (
        TimelineEvent(
...
def test_markdown_includes_all_sections():
    from engine.safety.postmortem_builder import build_draft, format_markdown
    d = build_draft(
...
def test_to_json_valid_serializable():
    from engine.safety.postmortem_builder import build_draft, to_json
    d = build_draft(
        incident_id="x", title="X", severity="P0",
        detected_at_iso="2026-05-15T10:00:00+00:00",
        resolved_at_iso="2026-05-15T10:30:00+00:00",
