"""engine.safety.emotion_disclosure — EU AI Act §50(3) 회귀 테스트."""
...
def test_eu_aggregate_code_required():
    from engine.safety.emotion_disclosure import is_emotion_disclosure_required
...
def test_disclosure_4_languages():
    from engine.safety.emotion_disclosure import build_emotion_disclosure
...
def test_inject_appends_for_eu():
    from engine.safety.emotion_disclosure import inject_emotion_disclosure
    base = "허허, 그대의 상을 살피니..."
...
def test_metadata_for_eu_has_legal_basis():
    from engine.safety.emotion_disclosure import get_disclosure_metadata
