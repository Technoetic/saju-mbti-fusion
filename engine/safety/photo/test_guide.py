"""engine.safety.photo.guide — §7.2.9 사진 가이드 회귀 테스트."""
...
def test_checklist_all_4_languages():
    from engine.safety.photo.guide import get_photo_checklist
...
def test_checklist_unknown_lang_falls_back_to_en():
    from engine.safety.photo.guide import get_photo_checklist, PHOTO_CHECKLIST_EN
...
def test_checklist_ko_uses_saguk_tone():
    ...
    from engine.safety.photo.guide import PHOTO_CHECKLIST_KO
...
def test_error_hint_known_codes_ko():
    from engine.safety.photo.guide import get_error_hint
...
def test_retry_tips_for_main_errors_ko():
    from engine.safety.photo.guide import get_retry_tips
...
def test_build_photo_guidance_no_error_returns_checklist_only():
    ...
    from engine.safety.photo.guide import build_photo_guidance
