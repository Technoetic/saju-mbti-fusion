"""engine.safety.crisis.resources — §7.2.12 회귀 테스트."""
...
def test_get_crisis_resources_kr():
    from engine.safety.crisis.resources import get_crisis_resources
...
def test_format_hotlines_text_korean():
    ...
    from engine.safety.crisis.resources import get_crisis_resources, format_hotlines_text
...
def test_format_hotlines_empty_input():
    from engine.safety.crisis.resources import format_hotlines_text
...
def test_at_least_seven_supported_regions():
    ...
    from engine.safety.crisis.resources import list_supported_crisis_regions
