"""engine.safety.input_guards.cost_guard — §7.2.17 비용 가드 회귀 테스트."""
...
def test_calculate_cost_gemini():
    from engine.safety.input_guards.cost_guard import calculate_cost
...
def test_initial_status_is_ok():
    from engine.safety.input_guards.cost_guard import CostTracker, CostBudget
...
def test_alert_payload_ok_is_p3():
    from engine.safety.input_guards.cost_guard import to_alert_payload
    t = _mk_tracker()
