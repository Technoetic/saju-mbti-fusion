"""engine.safety.input_guards.input_sanitizer — §7.2.15 입력 정제 회귀 테스트."""
...
def test_has_injection_attempt_quick_gate():
    from engine.safety.input_guards.input_sanitizer import has_injection_attempt
...
def test_sanitize_name_strips_newlines():
    from engine.safety.input_guards.input_sanitizer import sanitize_name
