"""engine.safety.model_card — §7.2.10 모델·데이터 카드 회귀 테스트."""
...
def test_model_card_sections_count():
    from engine.safety.model_card import MODEL_CARD_SECTIONS
    # Mitchell et al. 2019 표 3 — 9개 섹션
    assert len(MODEL_CARD_SECTIONS) == 9


def test_data_card_sections_count():
    from engine.safety.model_card import DATA_CARD_SECTIONS
...
def test_get_face_reading_model_card_basic_fields():
    from engine.safety.model_card import get_face_reading_model_card
...
def test_data_card_collection_sources_match_licit():
    ...
    from engine.safety.model_card import get_face_reading_data_card
    from engine.safety.data_governance import LICIT_SOURCES
    c = get_face_reading_data_card()
...
def test_validate_model_card_catches_missing_section():
    from engine.safety.model_card import ModelCard, validate_model_card
...
def test_validate_model_card_catches_empty_section():
    from engine.safety.model_card import ModelCard, validate_model_card, MODEL_CARD_SECTIONS
...
def test_card_to_dict_model_card_json_serializable():
    from engine.safety.model_card import get_face_reading_model_card, card_to_dict
...
def test_card_to_dict_data_card_has_kind():
    from engine.safety.model_card import get_face_reading_data_card, card_to_dict
