"""engine.safety.audit.quarterly_review — §14.9 회귀 테스트."""
...
def test_compute_mttr_empty():
    from engine.safety.audit.quarterly_review import compute_mttr_minutes
...
def test_grade_a_clean_quarter():
    from engine.safety.audit.quarterly_review import evaluate_grade
    g = evaluate_grade(
...
def test_next_quarter_focus_includes_p0_first():
    from engine.safety.audit.quarterly_review import derive_next_quarter_focus
...
def test_build_review_clean_quarter_grade_a():
    from engine.safety.audit.quarterly_review import build_review
    r = build_review(
...
def test_build_review_d_grade_for_p0():
    from engine.safety.audit.quarterly_review import build_review, IncidentSummary
    r = build_review(
        quarter_label="2026Q2",
        compliance_coverage_percent=100.0,
        incidents=[
...
def test_markdown_includes_all_sections():
    from engine.safety.audit.quarterly_review import build_review, format_markdown
    r = build_review(
        quarter_label="2026Q2",
        compliance_coverage_percent=100.0,
    )
...
def test_to_json_serializable():
    from engine.safety.audit.quarterly_review import build_review, to_json
