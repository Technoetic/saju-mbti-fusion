"""engine.safety.audit.onboarding_checklist — §14.6 회귀 테스트."""
...
def test_all_items_have_required_fields():
    from engine.safety.audit.onboarding_checklist import get_all_items
...
def test_get_item_known():
    from engine.safety.audit.onboarding_checklist import get_item, PHASE_DAY1
...
def test_get_item_unknown_returns_none():
    from engine.safety.audit.onboarding_checklist import get_item
...
def test_total_estimated_minutes_positive():
    from engine.safety.audit.onboarding_checklist import total_estimated_minutes
