...
_MANUAL: tuple[ManualEntry, ...] = (
    # ── input guard ──
    ManualEntry(
        module="engine.safety.input_sanitizer", standard_ref="§7.2.15",
        title="입력 정제기",
    ...
    ManualEntry(
        module="engine.safety.jailbreak_defense", standard_ref="§5.2.4",
        title="적대적 프롬프트 방어",
        category=CATEGORY_INPUT_GUARD, timing=(TIMING_PREFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.crisis_detector", standard_ref="§5.2.7",
        title="위기 신호 결정론 차단",
        category=CATEGORY_INPUT_GUARD, timing=(TIMING_PREFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.pii", standard_ref="§7.2.5",
        title="입력 PII 마스킹",
        category=CATEGORY_INPUT_GUARD, timing=(TIMING_PREFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.request_pipeline", standard_ref="§7.2.22",
    ...
    # ── output guard ──
    ManualEntry(
        module="engine.safety.persona_self_eval", standard_ref="§5.2.5",
        title="페르소나 톤 자체 평가",
    ...
    ManualEntry(
        module="engine.safety.output_token_guard", standard_ref="§5.2.6",
        title="출력 토큰 가드",
        category=CATEGORY_OUTPUT_GUARD, timing=(TIMING_POSTFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.response_fact_check", standard_ref="§5.2.8",
        title="응답 사실 검증",
        category=CATEGORY_OUTPUT_GUARD, timing=(TIMING_POSTFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.response_pii_leak", standard_ref="§7.2.18",
        title="응답 PII 누출 검출",
        category=CATEGORY_OUTPUT_GUARD, timing=(TIMING_POSTFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.response_alignment", standard_ref="§7.2.20",
        title="응답 주제 정렬 검증",
        category=CATEGORY_OUTPUT_GUARD, timing=(TIMING_POSTFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.response_consistency", standard_ref="§5.2.9",
        title="N개 응답 일관성 검증",
        category=CATEGORY_OUTPUT_GUARD, timing=(TIMING_POSTFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.output_safety_gate", standard_ref="§7.2.21",
        title="통합 출력 안전망",
        category=CATEGORY_OUTPUT_GUARD, timing=(TIMING_POSTFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.response_envelope", standard_ref="§7.2.13",
    ...
    ManualEntry(
        module="engine.safety.legal_notice", standard_ref="§7.1",
        title="법정 면책 자동 첨부",
        category=CATEGORY_OUTPUT_GUARD, timing=(TIMING_POSTFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.emotion_disclosure", standard_ref="EU AI Act §50(3)",
    ...
    # ── runtime ──
    ManualEntry(
        module="engine.safety.rate_limiter", standard_ref="§7.2.19",
    ...
    ManualEntry(
        module="engine.safety.cost_guard", standard_ref="§7.2.17",
        title="LLM 비용 한도 가드",
    ...
    ManualEntry(
        module="engine.safety.idempotency_key", standard_ref="§7.2.14",
        title="멱등 키 관리자",
        category=CATEGORY_RUNTIME, timing=(TIMING_PREFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.cache_key_resolver", standard_ref="§7.2.23",
        title="캐시 키 결정기",
    ...
    ManualEntry(
        module="engine.safety.cache_integrity", standard_ref="§7.2.16",
        title="캐시 무결성 검증",
    ...
    ManualEntry(
        module="engine.safety.cache_janitor", standard_ref="§7.2.12",
        title="캐시 TTL 청소",
        category=CATEGORY_RUNTIME, timing=(TIMING_PERIODIC,),
    ...
    ManualEntry(
        module="engine.safety.llm_fallback_router", standard_ref="§7.2.11",
        title="LLM 폴백 라우터",
    ...
    ManualEntry(
        module="engine.safety.photo_guide", standard_ref="§7.2.9",
        title="사진 촬영 가이드 (4언어)",
    ...
    # ── governance ──
    ManualEntry(
        module="engine.safety.consent_screen", standard_ref="§14.1",
        title="동의 화면 (4언어)",
    ...
    ManualEntry(
        module="engine.safety.data_governance", standard_ref="§7.3.3",
    ...
    ManualEntry(
        module="engine.safety.rights_information", standard_ref="§14.2",
    ...
    ManualEntry(
        module="engine.safety.dsr_processor", standard_ref="§10",
        title="DSR 처리 (4단계)",
    ...
    ManualEntry(
        module="engine.safety.regulation", standard_ref="§14",
        title="지역별 규제 프로파일",
        category=CATEGORY_GOVERNANCE, timing=(TIMING_PREFLIGHT,),
    ...
    ManualEntry(
        module="engine.safety.backup_manifest", standard_ref="§7.3.8",
        title="백업·복구 매니페스트",
        category=CATEGORY_GOVERNANCE, timing=(TIMING_PERIODIC,),
    ...
    # ── observability ──
    ManualEntry(
        module="engine.safety.tracing", standard_ref="§7.3.4",
    ...
    ManualEntry(
        module="engine.safety.slo", standard_ref="§7.3.2",
        title="SLO·KPI 측정",
    ...
    ManualEntry(
        module="engine.safety.latency_audit", standard_ref="§7.2.24",
    ...
    ManualEntry(
        module="engine.safety.quick_check", standard_ref="§7.3.5",
        title="빠른 점검 진입점",
        category=CATEGORY_OBSERVABILITY, timing=(TIMING_PERIODIC,),
    ...
    ManualEntry(
        module="engine.safety.canary_guard", standard_ref="§7.3.6",
        title="카나리 배포 가드",
        category=CATEGORY_OBSERVABILITY, timing=(TIMING_PERIODIC,),
    ...
    ManualEntry(
        module="engine.safety.shadow_eval", standard_ref="§7.3.9",
        title="셰도우 페어 평가",
        category=CATEGORY_OBSERVABILITY, timing=(TIMING_PERIODIC,),
    ...
    ManualEntry(
        module="engine.safety.feedback", standard_ref="§7.2.7",
        title="익명 피드백 카운트",
    ...
    ManualEntry(
        module="engine.safety.language", standard_ref="§7.2.3",
        title="언어 감지 + 외국어 안내",
    ...
    # ── incident ──
    ManualEntry(
        module="engine.safety.alert_router", standard_ref="§14.3",
    ...
    ManualEntry(
        module="engine.safety.rollback_trigger", standard_ref="§7.3.2.1",
        title="자동 롤백 정책",
        category=CATEGORY_INCIDENT, timing=(TIMING_RUNTIME,),
    ...
    ManualEntry(
        module="engine.safety.crisis_resources", standard_ref="§7.2.12",
        title="다국가 위기 핫라인",
        category=CATEGORY_INCIDENT, timing=(TIMING_RUNTIME,),
    ...
    ManualEntry(
        module="engine.safety.incident_playbook", standard_ref="§14.7",
        title="사고 대응 플레이북",
        category=CATEGORY_INCIDENT, timing=(TIMING_RUNTIME,),
    ...
    ManualEntry(
        module="engine.safety.postmortem_builder", standard_ref="§14.8",
        title="사후 검토 빌더",
    ...
    # ── docs ──
    ManualEntry(
        module="engine.safety.compliance_report", standard_ref="§14.4",
        title="운영표준 자체 점검",
    ...
    ManualEntry(
        module="engine.safety.model_card", standard_ref="§7.2.10",
    ...
    ManualEntry(
        module="engine.safety.standard_doc_builder", standard_ref="§14.5",
        title="운영표준 문서 빌더",
        category=CATEGORY_DOCS, timing=(TIMING_PERIODIC,),
    ...
    ManualEntry(
        module="engine.safety.onboarding_checklist", standard_ref="§14.6",
        title="신규 입사자 온보딩",
        category=CATEGORY_DOCS, timing=(TIMING_PERIODIC,),
    ...
    ManualEntry(
        module="engine.safety.quarterly_review", standard_ref="§14.9",
        title="분기별 운영 리뷰",
        category=CATEGORY_DOCS, timing=(TIMING_PERIODIC,),
