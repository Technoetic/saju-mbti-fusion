"""engine.safety.rights_information — §14.2 권리 행사 회귀 테스트."""
...
def test_rights_information_4_languages():
    from engine.safety.rights_information import get_rights_information
...
def test_rights_information_all_7_keys_present():
    from engine.safety.rights_information import get_rights_information, RIGHT_KEYS
    for lang in ("ko", "en", "ja", "zh"):
...
def test_withdraw_consent_is_automated():
    from engine.safety.rights_information import get_right_by_key
...
def test_list_automatable_rights():
    from engine.safety.rights_information import list_automatable_rights
