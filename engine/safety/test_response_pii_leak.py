"""engine.safety.response_pii_leak — §7.2.18 PII 누출 검출 회귀 테스트."""
...
def test_empty_text_clean():
    from engine.safety.response_pii_leak import scan
    r = scan("")
...
def test_phone_kr_010_detected():
    from engine.safety.response_pii_leak import scan, PII_PHONE_KR
...
def test_phone_intl_detected():
    from engine.safety.response_pii_leak import scan, PII_PHONE_INTL
...
def test_email_detected():
    from engine.safety.response_pii_leak import scan, PII_EMAIL
...
def test_kor_ssn_dashed_detected():
    from engine.safety.response_pii_leak import scan, PII_KOR_SSN
...
def test_credit_card_detected():
    from engine.safety.response_pii_leak import scan, PII_CREDIT_CARD
...
def test_ipv4_detected():
    from engine.safety.response_pii_leak import scan, PII_IPV4
...
def test_anthropic_api_key_detected():
    from engine.safety.response_pii_leak import scan, PII_API_KEY
...
def test_has_leak_quick_gate():
    from engine.safety.response_pii_leak import has_leak
...
def test_fallback_trigger_leak_maps_to_persona_failed():
    from engine.safety.response_pii_leak import scan, to_fallback_trigger
    r = scan("user@x.com")
