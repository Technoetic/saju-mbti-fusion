"""engine.safety.llm.response_alignment — §7.2.20 응답 정렬 회귀 테스트."""
...
def test_detect_topic_marriage():
    from engine.safety.llm.response_alignment import detect_topic
...
def test_check_response_topic_marriage_hit():
    from engine.safety.llm.response_alignment import check_response_topic
