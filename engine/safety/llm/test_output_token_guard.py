"""engine.safety.llm.output_token_guard — §5.2.6 출력 가드 회귀 테스트."""
...
def test_clean_response_no_issues():
    from engine.safety.llm.output_token_guard import evaluate_output
...
def test_empty_text_too_short():
    from engine.safety.llm.output_token_guard import evaluate_output, ISSUE_TOO_SHORT
...
def test_long_response_flagged():
    from engine.safety.llm.output_token_guard import evaluate_output, ISSUE_TOO_LONG
...
def test_truncated_no_terminal_marker():
    ...
    from engine.safety.llm.output_token_guard import evaluate_output, ISSUE_TRUNCATED
...
def test_repetition_detected():
    ...
    from engine.safety.llm.output_token_guard import evaluate_output, ISSUE_REPETITION
