"""engine.safety.prompt_cache_telemetry — 회귀 테스트.
...
def test_cache_hit_when_read_positive():
    from engine.safety.prompt_cache_telemetry import PromptCacheUsage
    u = PromptCacheUsage(
        input_tokens=100,
...
def test_extract_from_dict():
    from engine.safety.prompt_cache_telemetry import extract_usage
    usage_dict = {
        "input_tokens": 100,
...
def test_summarize_returns_flat_dict():
    from engine.safety.prompt_cache_telemetry import PromptCacheUsage, summarize
