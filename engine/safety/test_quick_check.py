"""engine.safety.quick_check — §7.3.5 빠른 점검 회귀 테스트."""
...
def test_run_quick_check_returns_top_level_keys():
    from engine.safety.quick_check import run_quick_check
    r = run_quick_check()
...
def test_format_text_contains_status_line():
    from engine.safety.quick_check import run_quick_check, format_quick_check_text
    r = run_quick_check()
...
def test_format_text_truncates_long_values():
    ...
    from engine.safety.quick_check import format_quick_check_text
    fake_report = {
