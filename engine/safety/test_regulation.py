"""engine.safety.regulation — 운영표준 §7.2.5 회귀 테스트."""
...
def test_get_regulation_profile_kr():
    from engine.safety.regulation import get_regulation_profile
...
def test_is_biometric_inference_restricted():
    ...
    from engine.safety.regulation import is_biometric_inference_restricted
...
def test_list_supported_regions():
    from engine.safety.regulation import list_supported_regions
