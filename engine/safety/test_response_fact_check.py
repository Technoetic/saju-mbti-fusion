"""engine.safety.response_fact_check — §5.2.8 응답 사실 검증 회귀 테스트."""
...
def test_age_mismatch_elderly_word_for_young_user():
    ...
    from engine.safety.response_fact_check import check_response, FACT_AGE
...
def test_gender_mismatch_female_word_for_male():
    from engine.safety.response_fact_check import check_response, FACT_GENDER
...
def test_face_count_one_but_multi_face_word():
    from engine.safety.response_fact_check import check_response, FACT_FACE_COUNT
...
def test_region_kr_but_european_word():
    from engine.safety.response_fact_check import check_response, FACT_REGION
...
def test_gaze_unlocked_but_strong_gaze_word():
    from engine.safety.response_fact_check import check_response, FACT_GAZE
