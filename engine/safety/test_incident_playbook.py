"""engine.safety.incident_playbook — §14.7 회귀 테스트."""
...
def test_all_playbooks_have_required_fields():
    from engine.safety.incident_playbook import get_all_playbooks
...
def test_at_least_one_p0_playbook_exists():
    from engine.safety.incident_playbook import list_p0_playbooks
...
def test_crisis_block_failed_is_p0():
    from engine.safety.incident_playbook import (
...
def test_get_playbook_unknown_returns_none():
    from engine.safety.incident_playbook import get_playbook
...
def test_list_by_severity_p0():
    from engine.safety.incident_playbook import list_playbooks_by_severity
