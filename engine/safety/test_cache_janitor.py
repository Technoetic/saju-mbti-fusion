"""engine.safety.cache_janitor — §7.2.12 캐시 청소 회귀 테스트."""
...
def test_find_expired_files_separates_fresh_and_expired(tmp_path):
    from engine.safety.cache_janitor import find_expired_files
...
def test_run_janitor_deletes_expired_keeps_fresh(tmp_path):
    from engine.safety.cache_janitor import run_janitor
...
def test_trace_event_fields(tmp_path):
    from engine.safety.cache_janitor import run_janitor, to_trace_event
