"""engine.safety.pii — §7.3.4.1 PII 마스킹기 단위 테스트."""
...
def test_hash_uid_deterministic():
    from engine.safety.pii import hash_uid
...
def test_hash_question_deterministic():
    from engine.safety.pii import hash_question
...
def test_mask_crisis_keyword_long():
    """긴 키워드는 앞 4자 + [...]"""
    from engine.safety.pii import mask_crisis_keyword
