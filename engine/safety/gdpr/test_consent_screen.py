"""engine.safety.gdpr.consent_screen — §14.1 동의 화면 회귀 테스트."""
...
def test_consent_screen_all_4_languages():
    from engine.safety.gdpr.consent_screen import get_consent_screen
...
def test_validate_consent_full_consent_passes():
    from engine.safety.gdpr.consent_screen import validate_consent_payload
