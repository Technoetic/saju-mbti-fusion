...
# 출처:
#   - 한국민족문화대백과사전 (encykorea.aks.ac.kr) — 화투 표제
#   - 국립민속박물관 e-museum (folkency.nfm.go.kr)
#   - Fuda Wiki·Wikipedia Hanafuda
# 학술 출처 보강 (ADR-111·112 영속화 시점, 2026-05-21):
#   - 권현주 (2011) "하나후다와 화투에 투영된 문화기호의 구조적 연구"
#   - 권현주 (2013) "하나후다(花札)와 화투(花鬪)의 문화기호를 중심으로 한
#     시니피에(signifier) 분석" KCI FI001859666
#   - 권현주 (2017) "화투의 놀이문화기호 재매개 과정 분석" KCI FI002241673
#   - 서강대학교 생명문화연구소 (2022) "화투의 과거, 현재, 미래" KCI FI002874136
# 학파 분화 (권현주 2017):
#   한국 화투는 일본 하나후다와 동일 모태 (1543 카르타 → 18C 우키요에 결합)
#   이나, 한국 정착 시 광·끗·피·띠 (청단·홍단·초단) 체계로 전면 재편 (독립 학파)
