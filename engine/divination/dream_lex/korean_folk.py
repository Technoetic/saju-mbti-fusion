...
KOREAN_FOLK_CATEGORIES = {
    ...
    # ADR-151 (2026-05-23) 한국 민간 카테고리 6 확장 — /domain-priorities #4 해소
    "조상몽": "조상·고향·제사 — 한국 민간 효(孝) 문화 핵심. 길 또는 경고로 양면 해석.",
    "자연몽": "산·강·하늘·바다 — 자연 자체의 등장. 한국 풍수·천인합일 사상 반영.",
    "음식몽": "음식·잔치·요리 — 풍요·인연의 모티프. 한국 식문화 특수성 (홍시·옹기·짚 등).",
    "옷몽": "옷·갓·짚신 — 한국 전통 의복의 출현. 정체성·신분 변화 신호.",
    "건물몽": "집·문·우물 — 한국 가옥 (한옥·옹기·아궁이 등) 등장. 가정·기반 모티프.",
    "동물몽": "한국 토착 동물 (까치·소·돼지·닭 등) 등장. 12지지·민간 동물상 학파 분기.",
}
