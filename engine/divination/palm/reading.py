...
_CACHE_DIR = Path(__file__).resolve().parent.parent.parent.parent / "step_archive" / "palm_reading_cache"
...
def _call_vision(
    ...
    # Anthropic fallback (ADR-143 Opus 4.7 단일 — ADR-214로 Sonnet 4.6 폴백 제거)
...
def generate_palm_reading(
    ...
    if text:
        ...
        # persona_self_eval.PERSONA_FORBIDDEN 전체 커버:
        # ("회원님", "고객님", "당신", "분명", "대박", "대운",
        #  "금전수", "재물수", "AI", "모델", "시스템")
        ...
        try:
            ...
            if gate_result.verdict in (VERDICT_WARN, VERDICT_CRITICAL):
                ...
                text = deterministic_stub_response("ko", persona="palm")
